...
export default class AircraftCommander {
    ...
    runShowEngine(aircraft) {
        var log_string = "Corrupted aircraft amount [Responser, Jumper, Errorer, Stopper, Modified Trajectory, Alarmers, Spoofers, Ghosts, Delayers]: " +GameController.responsers + ", ";
        log_string += GameController.jumpers+", "+GameController.errorers+", "+GameController.stoppers+", "+GameController.modifiedTrajectory+", "+GameController.alarmers + ", ";
        log_string += GameController.spoofers + ", " + GameController.ghosts + " sumAtk: ";
        log_string += (GameController.jumpers+GameController.stoppers+GameController.errorers+GameController.responsers+GameController.modifiedTrajectory+GameController.alarmers+GameController.spoofers+GameController.ghosts+GameController.delayers)
        log_string += " TOT:"+GameController.aircraft;
